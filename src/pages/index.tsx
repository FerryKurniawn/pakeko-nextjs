...
const Home = () => {
  ...
  return (
    <>
      <Head>
        <title>Toko Ikan Segar | EKO Pemangkat</title>
        <meta
          name="description"
          content="Toko ikan segar Pemangkat. Pesan ikan air tawar berkualitas, segar langsung dari kolam terbaik."
        />
        <meta property="og:title" content="Toko Ikan Segar | EKO Pemangkat" />
        <meta
          property="og:description"
          content="Pesan ikan segar langsung dari Pemangkat, Kalimantan Barat."
        />
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-40 mt-12">
            ...
            <div className="w-full md:w-5/12 text-center md:text-left text-gray-700 leading-relaxed px-4">
              ...
              <p className="text-lg max-w-md mx-auto md:mx-0">
                ...
                <span className="font-semibold">Pemangkat</span>, Kalimantan
                Barat. Kami bekerja sama dengan nelayan lokal untuk memastikan
                setiap ikan ditangkap segar, diproses higienis, dan dikirim
                tanpa perantara.
              </p>
            </div>
          </div>
